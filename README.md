...
```sh {"id":"01J4D1M2HFEPD6YGMFHF3CBXFB"}
hugo server
```
...
```sh {"id":"01J4D1HBTV748K9C0RVQSN21MM"}
$ hugo mod init github.com/<your_user>/<your_project>
```

Then add the theme to your `hugo.toml`:

```toml {"id":"01J4D1HBTV748K9C0RVR15RD2M"}
[module]
  [[module.imports]]
...
```sh {"id":"01J4D1HBTV748K9C0RVT45G0Q8"}
...
```ini {"id":"01J4D1HBTV748K9C0RVTW1BN47"}
content/
├── _index.md
...
```sh {"id":"01J4D1HBTWV9MC51GJC6HBDWX8"}
...
```markdown {"id":"01J4D1HBTWV9MC51GJC8G7SS55"}
---
...
```toml {"id":"01J4D1HBTWV9MC51GJC96AGR04"}
[params]
  ...
  [params.socialIcons]
...
[Example Site for Hugo Gallery Theme](git@github.com:nicokaiser/hugo-theme-gallery.git)

# Acknowledgements

* [Nico Kaiser](https://kaiser.me/) - Creator of the Hugo Theme
